...
import { DivPilot, Header, DivCard, PiTitle, ImageContainer, ImagePilot, DivDescription, InfoTxt, TxtPilot } from './Pilot-styled';
...
const Pilot = ({ idPilot }) => {
    ...
    useEffect(() => {
        fetch(`https://swapi.dev/api/people/${idPilot}/`)
            .then((response) => response.json())
            .then(res => {
                //console.log(idPilot, "res", res);
                setPilotData(res);
            })
